...
class ArstistApiViewSet(ModelViewSet):
    queryset = Artist.get_info_artist()
...
# albom = Albom.get_info_albom().get(id=1).songs.all()
# print('fffffffffffffffffffffffffffff', albom)
class AlbomApiViewSet(ModelViewSet):
    queryset = Albom.get_info_albom()
